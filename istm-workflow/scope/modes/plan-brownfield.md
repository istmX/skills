...
2. Plan the next slice as `planned` rows; don't plan `existing` features again. No root `.istm-context/agents.md`: note in the report that `/audit` should run first for real context.
