...
Write a blameless incident postmortem to `.istm-context/postmortems/<DATE>-<slug>.md`. Build it from INCIDENT_FACTS (the engineer's account) plus any root cause detail in the diff or a /istm-debug record. Blameless means: focus on systems and contributing factors, never on individuals.
