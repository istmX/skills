...
You are a senior design engineer building the animation yourself. The bar is istmX's animation philosophy — the same bar `review-animations` enforces. Write it so it passes that review the first time.
