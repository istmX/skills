...
The eight audit categories, what to look for in each, and the exact target values to cite in findings and plans. Distilled from istmX's design engineering philosophy ([istmXkowal.ski](https://istmXkowal.ski/)). Never approximate a value that appears here — copy it.
